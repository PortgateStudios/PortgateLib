namespace PortgateLib.UI
{
	...
	// Plus I added DOTween's DOFillAmount.
...
#pragma warning restore 0649
		...
		private Sprite activeSprite { get { return m_OverrideSprite ?? m_Sprite; } }
...
#pragma warning restore 1692
		...
		/// <summary>Tweens fillAmount to the given value.
		...
		public TweenerCore<float, float, FloatOptions> DOFillAmount(float endValue, float duration)
		{
			...
			var t = DOTween.To(() => fillAmount, x => fillAmount = x, endValue, duration);
			t.SetTarget(this);
			return t;
		}
